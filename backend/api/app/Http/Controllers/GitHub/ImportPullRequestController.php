<?php
    ...
    use App\Contexts\GitHubApi\UseCase\ImportPullRequestsUseCase;
    use App\Http\Controllers\Controller;
    use Exception;
    use Illuminate\Http\JsonResponse;
    use Illuminate\Http\Request;

    class ImportPullRequestController extends Controller
    {
        public function __construct(
            private readonly ImportPullRequestsUseCase $useCase
        )
        {
        }
        ...
        public function __invoke(Request $request): JsonResponse
        {
            try {
                ...
                return response()->json([
                    'success' => true,
                    'message' => ApiMessages::PULL_REQUESTS_IMPORTED_SUCCESS,
